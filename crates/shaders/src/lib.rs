...
pub fn depth_pyramid_main(
    ...
    let d0 = unsafe {
        dst_heap::storage_buffer_load_from_u32::<f32>(constants.pyramid_handle, src_index0 as u32)
    };
    let d1 = unsafe {
        dst_heap::storage_buffer_load_from_u32::<f32>(constants.pyramid_handle, src_index1 as u32)
    };
    let d2 = unsafe {
        dst_heap::storage_buffer_load_from_u32::<f32>(constants.pyramid_handle, src_index2 as u32)
    };
    let d3 = unsafe {
        dst_heap::storage_buffer_load_from_u32::<f32>(constants.pyramid_handle, src_index3 as u32)
    };
    ...
    unsafe {
        dst_heap::storage_buffer_store_from_u32::<f32>(
            constants.pyramid_handle,
            dst_index as u32,
            max_depth,
        );
    }
